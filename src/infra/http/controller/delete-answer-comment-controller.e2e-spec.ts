...
describe('Delete answer comment (E2E)', () => {
  ...
  let answerCommentFcatory: AnswerCommentFactory
  let jwt: JwtService
  ...
  beforeAll(async () => {
    ...
    answerCommentFcatory = moduleRef.get(AnswerCommentFactory)
  ...
  test('[Delete] /answer/comment/:id', async () => {
    ...
    const answerComment = await answerCommentFcatory.makePrismaAnswerComment({
      answerId: answer.id,
      authorId: user.id,
    })
